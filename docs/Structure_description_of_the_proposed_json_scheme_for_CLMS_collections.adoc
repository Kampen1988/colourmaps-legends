...
----
{
  "schemaVersion": "M.m.p",
  "eodataPath": "",
  "browserNameVisualiseTab": "",
  "browserNameSearchTab": "",
  "browserSearchPath": "",
...
The name that should appear in the VISUALISE tab of the Browser and https://documentation.dataspace.copernicus.eu/APIs/SentinelHub/Data/CLMS.html[CDSE Sentinel Hub CLMS documentation]. e.g. `SSM 1km Daily V1` This should follow the convention:
...
The name that should appear in the SEARCH tab of the Browser (e.g. abbreviated vs. full product name); Leave empty if the same as browserNameVisualiseTab.
